...
import aritra.seal.mychatapp.DestinationScreen
import aritra.seal.mychatapp.LCViewModel
import aritra.seal.mychatapp.R
import aritra.seal.mychatapp.navigateTo
...
fun SignUpScreen( navController: NavController,vm : LCViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize())
    {
        ...
        )
        {
            ...
            Text(text = "Already a user ? Login here",
                modifier = Modifier
                    .padding(8.dp)
                    .clickable {
